...
public class QuaTestInfoActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        tvTitle.setText(getResources().getString(R.string.txt_qualification_info));
        if (listResult != null) {
        ...
        CyzgksxxAdapter blackListAdapter = new CyzgksxxAdapter(QuaTestInfoActivity.this, listResult);
        lvBlackList.setAdapter(blackListAdapter);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_cyzgksxx;
    }
