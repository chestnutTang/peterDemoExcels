 ...
 * 默认水平开始排布
 */
public class RadioGroupEx extends ViewGroup {
        ...
        /** 子控件左边距 */
        private int childMarginLeft = 30;

        /** 子控件右边距 */
        private int childMarginRight = 30;

        /** 子控件上边距 */
        private int childMarginTop = 20;
        ...
        public interface OnCheckedChangeListener {
             ...
             */
            void onCheckedChanged(RadioGroupEx group, int checkedId);
        }
